...
describe('AlertItem Component', () => {
    ...
    beforeEach(() => {
        store = mockStore({
            alert: [
                { wallet: "test", asset: "ETH", network: "ERC20", balance: 0.34, price: 1.2, updated: "26.03.2024T12:00:00" },
                { wallet: "test_2", asset: "ETH", network: "ERC20", balance: 5.4, price: 0, updated: "26.03.2024T16:00:00" }
            ]
        });
